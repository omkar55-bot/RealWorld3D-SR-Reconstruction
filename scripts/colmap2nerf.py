...
def run_colmap(args):
	...
	if os.path.exists(db):
		os.remove(db)
	#do_system(f"{colmap_binary} feature_extractor --ImageReader.camera_model {args.colmap_camera_model} --ImageReader.camera_params \"{args.colmap_camera_params}\" --SiftExtraction.use_gpu=0 --SiftExtraction.estimate_affine_shape=true --#SiftExtraction.domain_size_pooling=true --ImageReader.single_camera 1 --database_path {db} --image_path {images}")
	do_system(f"{colmap_binary} feature_extractor --ImageReader.camera_model {args.colmap_camera_model} --ImageReader.camera_params \"{args.colmap_camera_params}\" --ImageReader.single_camera 1 --SiftExtraction.use_gpu=0 --SiftExtraction.estimate_affine_shape=false --SiftExtraction.domain_size_pooling=false --SiftExtraction.max_image_size=1600 --SiftExtraction.first_octave=0 --database_path {db} --image_path {images}")
